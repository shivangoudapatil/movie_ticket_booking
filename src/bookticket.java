...
class
bookticket extends JFrame implements ActionListener {
    ...
    bookticket(String moviename, String username) {
        ...
        frame.setContentPane(new JLabel(new ImageIcon(
                new ImageIcon("E:\\Projects\\Movie-Ticket-Booking-System-main\\model\\Images\\moviereel.jpg")
        ...
        selectSeatType.setBackground(Color.LIGHT_GRAY);

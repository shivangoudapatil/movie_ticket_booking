...
class ManagerView implements ActionListener, User {
    ...
    ManagerView() {
        ...
        frame.setContentPane(new JLabel(new ImageIcon(
                new ImageIcon("D:\\std\\ooad\\project\\Movie-Ticket-Booking-System-main\\model\\Images\\moviereel.jpg")
...
class userView implements ActionListener, User {
    ...
    JButton reviewButton2 = new JButton("Veiw Review");
    JTable tblData;
    JScrollPane jScrollPane2 = new javax.swing.JScrollPane();
    String path = "D:\\std\\ooad\\project\\Movie-Ticket-Booking-System-main\\model\\Images\\";
    ...
    userView(String username) {
        ...
        reviewButton2.setBounds(350, 550, 200, 30);
        reviewButton2.addActionListener(this);
        reviewButton2.setFocusable(false);
        frame.add(reviewButton2);

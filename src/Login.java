...
public class Login implements ActionListener {
    ...
    Login() {
        frame.setContentPane(new JLabel(new ImageIcon(
                new ImageIcon("D:\\std\\ooad\\project\\Movie-Ticket-Booking-System-main\\model\\Images\\moviereel.jpg").getImage().getScaledInstance(1000, 650,
                        Image.SCALE_DEFAULT))));
        ...
        ImageLabel.setIcon(new ImageIcon(
                new ImageIcon("D:\\std\\ooad\\project\\Movie-Ticket-Booking-System-main\\model\\Images\\manager.jpg").getImage().getScaledInstance(200, 200, Image.SCALE_DEFAULT)));
